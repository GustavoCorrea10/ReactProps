...
function Tarefa() {
  ...
  )//aqui tem o botão, que chama o metodo setCompleted, que é a função da variavel completed
  //que assim que clicado ele aciona a função useEffect e executa a sua função
}
